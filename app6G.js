...
function initMap() {
     ...
     function populateInfoWindow (marker, infowindow, place){
       if (infowindow.marker != marker){
         ...
         var nyturl = "https://api.nytimes.com/svc/search/v2/articlesearch.json?q=' + place + '&sort=newest&apikey=79d4af5d735d40dd8f025ac8a3923bf8";
